...
set CONFIG_GROUP_MEM "sb_12__config_group_mem_size315"
set MUX_NAME_LIST {"sb_mux_size8" "sb_mux_size7" "sb_mux_size6" "sb_mux_size11" "sb_mux_size10" "sb_mux_size9" "clk_mux_size3" "sb_mux_size5" "sb_mux_size4" "sb_mux_size2" }
define_name_rules naming_mem_cell -map {{{"^sb_12__config_group_mem_size315/",""}}} -type cell
define_name_rules naming_mem_net -map {{{"^sb_12__config_group_mem_size315/",""}}} -type net
...
source /rapidsilicon/data/ArkAngel_Engineering_v0.9.841/bin/..//etc/device/ALKDC/synth/sdc/sb/area.tcl
source /rapidsilicon/data/ArkAngel_Engineering_v0.9.841/bin/..//etc/device/ALKDC/synth/sdc/sb/timing.tcl
source /rapidsilicon/data/ArkAngel_Engineering_v0.9.841/bin/..//etc/device/ALKDC/synth/sdc/sb/power.tcl
link
compile_ultra
...
write -format verilog -hierarchy -output /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/netlist/gl/dp/subblock/sb_12_.v
exec /bin/sh -c "sed -i 's/.*Date.*//g' /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/netlist/gl/dp/subblock/sb_12_.v"
# Report area to file
file mkdir /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_12_
redirect -file "/home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_12_/area.rpt" {
	report_reference -nosplit -hierarchy
	report_area
}
exec /bin/sh -c "sed -i 's/.*Date.*/--removed--/g' /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_12_/area.rpt"
# Report timing to file
file mkdir /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_12_
redirect -file "/home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_12_/timing.rpt" {
	report_timing
}
exec /bin/sh -c "sed -i 's/.*Date.*/--removed--/g' /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_12_/timing.rpt"
# Report power to file
file mkdir /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_12_
redirect -file "/home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_12_/power.rpt" {
	report_power -hierarchy -levels 2
}
exec /bin/sh -c "sed -i 's/.*Date.*/--removed--/g' /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_12_/power.rpt"
exit
