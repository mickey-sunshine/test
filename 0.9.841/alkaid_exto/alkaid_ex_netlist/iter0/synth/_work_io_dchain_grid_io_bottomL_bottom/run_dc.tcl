...
set target_library "/eda/internal/alkaid_infra/pdk/s40/s40ulp/std_cell/SCC40ULP_UHDC40_HVT/V0p2/liberty/1.1v/scc40ulp_uhdc40_hvt_tt_v1p1_25c_basic.db /eda/internal/alkaid_infra/pdk/s40/s40ulp/std_cell/SCC40ULP_UHDC40_RVT_V0p2/liberty/1.1v/scc40ulp_uhdc40_rvt_tt_v1p1_25c_basic.db"
# Global paths
...
elaborate grid_io_bottomL_bottom
# Variables for micro floorplan synth
set CONFIG_GROUP_MEM "grid_io_bottomL_bottom_config_group_mem_size140"
define_name_rules naming_mem_cell -map {{{"^grid_io_bottomL_bottom_config_group_mem_size140/",""}}} -type cell
define_name_rules naming_mem_net -map {{{"^grid_io_bottomL_bottom_config_group_mem_size140/",""}}} -type net
...
source /rapidsilicon/data/ArkAngel_Engineering_v0.9.841/bin/..//etc/device/ALKDC/synth/sdc/io/area_dchain.tcl
source /rapidsilicon/data/ArkAngel_Engineering_v0.9.841/bin/..//etc/device/ALKDC/synth/sdc/io/timing.tcl
source /rapidsilicon/data/ArkAngel_Engineering_v0.9.841/bin/..//etc/device/ALKDC/synth/sdc/io/power.tcl
link
compile_ultra
...
write -format verilog -hierarchy -output /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/netlist/gl/dp/subblock/grid_io_bottomL_bottom.v
exec /bin/sh -c "sed -i 's/.*Date.*//g' /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/netlist/gl/dp/subblock/grid_io_bottomL_bottom.v"
# Report area to file
file mkdir /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/grid_io_bottomL_bottom
redirect -file "/home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/grid_io_bottomL_bottom/area.rpt" {
	report_reference -nosplit -hierarchy
	report_area
}
exec /bin/sh -c "sed -i 's/.*Date.*/--removed--/g' /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/grid_io_bottomL_bottom/area.rpt"
# Report timing to file
file mkdir /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/grid_io_bottomL_bottom
redirect -file "/home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/grid_io_bottomL_bottom/timing.rpt" {
	report_timing
}
exec /bin/sh -c "sed -i 's/.*Date.*/--removed--/g' /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/grid_io_bottomL_bottom/timing.rpt"
# Report power to file
file mkdir /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/grid_io_bottomL_bottom
redirect -file "/home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/grid_io_bottomL_bottom/power.rpt" {
	report_power -hierarchy -levels 2
}
exec /bin/sh -c "sed -i 's/.*Date.*/--removed--/g' /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/grid_io_bottomL_bottom/power.rpt"
exit
