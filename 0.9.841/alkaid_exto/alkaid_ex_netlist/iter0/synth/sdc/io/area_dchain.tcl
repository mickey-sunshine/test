...
set PIPDCECB_DESIGN_NAME "logical_tile_io_pi_pdc_ecb1_mode_io_pi_pdc_ecb1_"
set PIPDCECB_CLK_XBAR_NAME "clock_crossbar_pi"
set PIPDCECB_CLK_XBAR_CELLS "mux_iopad_*_clk_*"
...
# Never touch delay cells 
# Design variables
set PIPDCECB_DCELL_DESIGN_NAME "delay_cell"
# Synthesis FF for PI separately
set CURR_DESIGN_NAME [current_design]
current_design ${PIPDCECB_DCELL_DESIGN_NAME}
# Compile with L40 only
remove_target_library_subset
#set_target_library_subset -dont_use "*/*L40*"
set_target_library_subset -dont_use [get_lib_cells {*hvt*/* *rvt*/*V1* *rvt*/*V2* *rvt*/*V3*}]
#compile_ultra
current_design ${CURR_DESIGN_NAME}
set_dont_touch [get_cells -hierarchical -filter "ref_name == ${PIPDCECB_DCELL_DESIGN_NAME}"]

# Design variables
set PIPDCECB_DCELL_DESIGN_NAME "delay_cell"
set PIPDCECB_DCHAIN_DESIGN_NAME "pinput_dchain_extmode"
# Synthesis FF for PI separately
set CURR_DESIGN_NAME [current_design]
current_design ${PIPDCECB_DCHAIN_DESIGN_NAME}
# Compile with L40 only
remove_target_library_subset
set_target_library_subset -dont_use "*/*L40*"
set_dont_touch [get_cells -hierarchical -filter "ref_name == ${PIPDCECB_DCELL_DESIGN_NAME}"]
...
compile
current_design ${CURR_DESIGN_NAME}
set_dont_touch [get_cells -hierarchical -filter "ref_name == ${PIPDCECB_DCHAIN_DESIGN_NAME}"]

# Design variables
set PIPDCECB_FF_DESIGN_NAME "logical_tile_io_pi_pdc_ecb1_mode_io_pi_pdc_ecb1_physical_mode__pi_pdc_ecb1_pad_mode_pi_pdc_ecb1_pad_default_mode__p_io_pdc_ecb1_scffi_p_io_pdc_ecb1_scffi"
# Synthesis FF for PI separately
set CURR_DESIGN_NAME [current_design]
current_design ${PIPDCECB_FF_DESIGN_NAME}
# Compile with L40 only
remove_target_library_subset
#set_target_library_subset -dont_use "*/*L40*"
set_target_library_subset -dont_use [get_lib_cells {*hvt*/* *rvt*/*V1* *rvt*/*V2* *rvt*/*V3*}]
...
compile_ultra
current_design ${CURR_DESIGN_NAME}
set_dont_touch [get_cells -hierarchical -filter "ref_name == ${PIPDCECB_FF_DESIGN_NAME}"]

# Synthesis PI separately
set CURR_DESIGN_NAME [current_design]
current_design ${PIPDCECB_DESIGN_NAME}
# Compile with L40 only
remove_target_library_subset
#set_target_library_subset -dont_use "*/*L40*"
set_target_library_subset -dont_use [get_lib_cells {*hvt*/* *rvt*/*V1* *rvt*/*V2* *rvt*/*V3*}]
set_load -pin_load $L1_LOAD [get_ports "gfpga_pad_pinput_dchain_extmode_A2F*"]
...
#ungroup -flatten -all
current_design ${CURR_DESIGN_NAME}
set_dont_touch [get_cells -hierarchical -filter "ref_name == ${PIPDCECB_DESIGN_NAME}"]
