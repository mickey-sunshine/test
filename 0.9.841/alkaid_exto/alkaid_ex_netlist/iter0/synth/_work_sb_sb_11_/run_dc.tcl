...
set CONFIG_GROUP_MEM "sb_11__config_group_mem_size358"
set MUX_NAME_LIST {"sb_mux_size15" "sb_mux_size13" "sb_mux_size11" "sb_mux_size21" "sb_mux_size19" "clk_mux_size3" "sb_mux_size10" "sb_mux_size8" "sb_mux_size9" }
define_name_rules naming_mem_cell -map {{{"^sb_11__config_group_mem_size358/",""}}} -type cell
define_name_rules naming_mem_net -map {{{"^sb_11__config_group_mem_size358/",""}}} -type net
...
write -format verilog -hierarchy -output /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/netlist/gl/dp/subblock/sb_11_.v
exec /bin/sh -c "sed -i 's/.*Date.*//g' /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/netlist/gl/dp/subblock/sb_11_.v"
# Report area to file
file mkdir /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_11_
redirect -file "/home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_11_/area.rpt" {
	report_reference -nosplit -hierarchy
	report_area
}
exec /bin/sh -c "sed -i 's/.*Date.*/--removed--/g' /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_11_/area.rpt"
# Report timing to file
file mkdir /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_11_
redirect -file "/home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_11_/timing.rpt" {
	report_timing
}
exec /bin/sh -c "sed -i 's/.*Date.*/--removed--/g' /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_11_/timing.rpt"
# Report power to file
file mkdir /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_11_
redirect -file "/home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_11_/power.rpt" {
	report_power -hierarchy -levels 2
}
exec /bin/sh -c "sed -i 's/.*Date.*/--removed--/g' /home/yhjiang/Desktop/test_project/to_Mickey/20250911/0.9.841/alkaid_exto/alkaid_ex_netlist/iter0/synth/reports/sb_11_/power.rpt"
exit
